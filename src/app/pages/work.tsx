...
const otherProjects = [
  ...
  },
  {
    ...
    year: '2023',
    description: 'Designed real-time operational monitoring dashboards for supply chain logistics with predictive analytics.',
    role: 'Principal Designer',
    image: 'https://images.unsplash.com/photo-1759661966728-4a02e3c6ed91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkYXRhJTIwdmlzdWFsaXphdGlvbiUyMGRhc2hib2FyZHxlbnwxfHx8fDE3NzA1OTI5NDl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
  {
    title: 'Design Thinking Workshop Platform',
    category: 'Collaboration Tools',
    year: '2023',
    description: 'Built a collaborative workshop platform for remote design thinking sessions with real-time collaboration features.',
    role: 'Lead Product Designer',
    image: 'https://images.unsplash.com/photo-1562939651-9359f291c988?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZXNpZ24lMjB0aGlua2luZyUyMHdvcmtzaG9wfGVufDF8fHx8MTc3MDY0NDUzN3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
  {
    title: 'Wireframing & Prototyping Tool',
    category: 'Design Tools',
    year: '2022',
    description: 'Contributed to UX improvements for a wireframing tool used by 50,000+ designers globally.',
    role: 'Senior UX Designer',
    image: 'https://images.unsplash.com/photo-1523726491678-bf852e717f6a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3aXJlZnJhbWUlMjBza2V0Y2hlcyUyMG5vdGVib29rfGVufDF8fHx8MTc3MDY0MTA5NXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
  {
    title: 'Product Design System Components',
    category: 'Component Library',
    year: '2022',
    description: 'Created a comprehensive component library for a B2B SaaS platform with accessibility at its core.',
    role: 'Design Systems Designer',
    image: 'https://images.unsplash.com/photo-1562601555-513820e5d0eb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZXNpZ24lMjBzeXN0ZW0lMjBjb21wb25lbnRzJTIwdWl8ZW58MXx8fHwxNzcwNjE5MjI3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {otherProjects.map((project, index) => (
              <motion.button
                ...
                className="group text-left bg-background border border-border hover:shadow-lg transition-all duration-300"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
